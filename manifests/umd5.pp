...
class umd::umd5 (
  ...
  yumrepo { 'UMD-5':
    ...
    baseurl  => 'https://repository.egi.eu/software/umd/5/al9/release/$basearch',
    enabled  => 1,
    priority => 1,
    gpgcheck => 1,
    gpgkey   => 'https://repository.egi.eu/software/umd/5/UMD-5-RPM-PGP-KEY',
  }
  if $enable_contrib {
  ...
  yumrepo { 'UMD-5-contrib':
    ...
    baseurl  => 'https://repository.egi.eu/software/umd/5/al9/contrib/$basearch',
  ...
  yumrepo { 'UMD-5-testing':
    ...
    baseurl  => 'https://repository.egi.eu/software/umd/5/al9/testing/$basearch',
